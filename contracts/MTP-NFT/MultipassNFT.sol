...
contract MultipassNFT is ERC721Upgradeable, OwnableUpgradeable {
    ...
    function initialize(string memory mtpMeta_) public initializer {
        __ERC721_init("MultipassNFT", "MultiPass Authorization Card");
    ...
    function mint(address to, string calldata code_) external onlyMinter {
        ...
        require(_tokenIds < maxSupply, "Exceeds maximum supply");
    ...
    function mintBatch(
        ...
        require(_tokenIds + amount <= maxSupply, "Exceeds maximum supply");
    ...
    // https://coral-delicate-basilisk-291.mypinata.cloud/ipfs/bafkreigfyyjr3gue7ay2slzuxowgf7rkvypggt4nvs663bkpxtsldqhlbm
