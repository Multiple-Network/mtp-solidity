...
contract MTP5000 is ERC721A, Ownable {
    string private constant metaFile = "Meta5000.json";
    uint public constant value = 5000;

    constructor(address to) ERC721A("MTP-5000", "MTP-5000") Ownable() {
        mint(to, 50);
    }
